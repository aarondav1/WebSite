WebSite - Modern & Minimal Theme for Jekyll
======
WebSite is a minimal blog theme for Jekyll.
...
Check the theme in action [Demo](https://WebSite-jekyll.netlify.app/)

![Main page preview](https://github.com/artemsheludko/WebSite/blob/master/images/WebSite-main-page.png?raw=true)

The post page would look like this:

![Post page preview](https://github.com/artemsheludko/WebSite/blob/master/images/WebSite-post.png?raw=true)
...
WebSite Theme comes with Disqus comments enabled.
